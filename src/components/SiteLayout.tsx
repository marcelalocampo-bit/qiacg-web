...
function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 sm:p-6 bg-[#1a1a1a] border-t border-white/10 shadow-2xl animate-fade-up">
      <div className="container-x flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-sm text-gray-300 flex-1">
          Utilizamos cookies para mejorar tu experiencia en nuestro sitio web. Al continuar navegando, aceptas nuestra política de privacidad y tratamiento de datos.
        </p>
        <button 
          onClick={() => {
          ...
          className="whitespace-nowrap rounded-full bg-gradient-gold px-6 py-2 text-sm font-medium text-black shadow-gold hover:scale-105 transition"
        >
          Aceptar y continuar
        </button>
      </div>
